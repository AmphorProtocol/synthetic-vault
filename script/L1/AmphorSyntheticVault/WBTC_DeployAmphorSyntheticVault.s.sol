...
contract L1_WBTC_DeployAmphorSyntheticVault is Script {
    function run() external {
        ...
        ERC20 underlying = ERC20(vm.envAddress("WBTC_MAINNET"));
        ...
        AmphorSyntheticVault amphorSyntheticVault = new AmphorSyntheticVault(
                underlying,
                vaultName,
                vaultSymbol,
                decimalOffset
        ...
        console.log(
            "Synthetic vault WBTC contract address: ",
