...
abstract contract BaseProperties is GlobalTest {
    ...
    function test_previewWithdraw(
        ...
        console.log("vaultopen value %s", _vault.convertToAssets(_vault.balanceOf(address(this))));
        console.log("vault assets value %s", _underlying.balanceOf(address(_vault)));
    ...
    function test_mint(
        ...
        console.log(
            "%s actual shares = %s actual assets",
            shares,
            assets
        );
    }
    ...
    function test_withdraw(
        ...
        console.log("vaultopen value %s", _vault.convertToAssets(_vault.balanceOf(owner)));
        console.log("vault assets value %s", _underlying.balanceOf(address(_vault)));
